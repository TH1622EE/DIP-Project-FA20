...
enhancedV_overall = roifilt2(enhancedV_under,BW,funDark);
HSVenhancedV_overall = cat(3,H,S,enhancedV_overall);
RGBenhancedV_overall = hsv2rgb(HSVenhancedV_overall);
stdenhancedV_overall = std2(enhancedV_overall);  % Standard deviation of the enhancedV channel

enhancedVeq_overall = roifilt2(enhancedVeq_under,BW,funDark);
HSVenhancedVeq_overall = cat(3,H,S,enhancedVeq_overall);
RGBenhancedVeq_overall = hsv2rgb(HSVenhancedVeq_overall);
stdenhancedVeq_overall = std2(enhancedVeq_overall);  % Standard deviation of the enhancedV channel
toc
